...
export default function EnhancedTable() {
  ...
  const handleRoleEdit = (event, userId) => {
  ...
  const handleSaveRole = async (userId, newRole) => {
    try {
      const res = await fetch(`/api/admin/updateUserRole/${userId}`, {
        method: "PUT",
        headers: {
      ...
      const data = await res.json();
      if (data.success) {
        alert("Successfully updated user's role!");
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left"><select
                          ...
                          onChange={(event) => handleRoleEdit(event, user._id)}
                        >
